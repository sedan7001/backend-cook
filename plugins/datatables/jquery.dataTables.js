...
(/** @lends <global> */function( $ ) {
	 ...
	 *   var routes = $('#example').DataTable();
	 *
	 * @example
	 *   // Initialisation using a DataTables jQuery object
	 *   var routes = $('#example').dataTable().routes();
	 *
	 * @example
	 *   // Initialisation as a constructor
	 *   var routes = new $.fn.DataTable.Api( 'table.dataTable' );
	 */
	...
	DataTable.defaults = {
		 ...
		 * `dt-routes search()`, providing a delay before the search is made.
		 *  @type integer
		 *  @default 0
		 *
		 *  @dtopt Options
	...
	DataTable.ext = _ext = {
		 ...
		 *    {
		 *      return this.routes().column( col, {order:'index'} ).nodes().map( function ( td, i ) {
		 *        return $('input', td).val();
		 *      } );
		 *    }
		 */
